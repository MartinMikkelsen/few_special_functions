...
const XI_10: [f64; 10] = [
    1.02058363572825669e-1, 1.10087335344093285e0, 3.87538426676163313e0,
    9.49089900532915982e0,  1.92369217680950509e1, 3.48489807870071239e1,
    5.88422971202513756e1,  9.52057687864990326e1, 1.51245498588511132e2,
    2.44769266678480451e2,
];
const A_10: [f64; 10] = [
    1.03011687962788351e0,  2.2580220852505727e-1,  1.67040618192678355e-2,
    6.0460703772163201e-4,  1.16718411051188568e-5,  1.1536011315284419e-7,
    5.23125205372251291e-10, 8.88585842372452499e-13, 3.78823474931504689e-16,
    1.45749170427449731e-20,
];

// Gauss-Laguerre nodes and weights for N = 20 (extended precision)
const XI_20: [f64; 20] = [
    7.8332741180217739859429592034215121e-2, 7.99480557580280868888504305965764455e-1,
    2.633559843707676053063024600681851e0,   6.067125354800522713778706639849939e0,
    1.1578014308014972867250241260973853e1,  1.967574219682007399786022325652155e1,
    3.09284092373144262920338413642651e1,    4.5988905145672958078531429470368746e1,
    6.5602547968040040431325251181403039e1,  9.0652159037294131940072043099536872e1,
    1.2218773346692348159267034032123833e2,  1.6148763659034474884235758941294436e2,
    2.1014062487874825104404326118075493e2,  2.7017538454329128248632034154940478e2,
    3.4427146853197803740611415515669254e2,  4.3612864159248546858458013080006752e2,
    5.5117670639883226012194621182330183e2,  6.9813208096151573112006881397004676e2,
    8.9318894895282773667447559458923804e2,  1.1765731082977506193890547798997328e3,
];
const A_20: [f64; 20] = [
    9.4521844770213813522739498751084446e-1,  2.8673730910005180272566734208681658e-1,
    3.7990715886134892035536939814054822e-2,  3.1053688857936936821748901103472756e-3,
    1.7979523985634735267965413590172828e-4,  7.6599061254187375464405113636273785e-6,
    2.4224398021113042502544194520811499e-7,  5.67246161661686603385118458797347e-9,
    9.740052786086906643974014704731242e-11,  1.2068824524541185034179793734503826e-12,
    1.0549929160747159130056637444912904e-14, 6.3107861649521708824465976542847217e-17,
    2.4806740961948186082790889707150879e-19, 6.068944075643647849080969319008971e-22,
    8.5770997286711710319485672039762078e-25, 6.296750414836763110694582719147875e-28,
    2.0455706071903958823179960004147795e-31, 2.258006419692752335532584347360038e-35,
    5.1214712907227134883116239441893341e-40, 6.6554055933455521526556015293110494e-46,
];
...
const TINY: Complex<f64> = Complex { re: 1e-150, im: 0.0 };
    ...
    if z.norm() < 2.0 {
        ...
        for j in 1_usize..=300 {
            ...
            d = b + a * d;
            if d.norm() < 1e-150 { d = TINY; }
            d = d.inv();

            c = b + a / c;
            if c.norm() < 1e-150 { c = TINY; }
...
fn f_clausen(n: usize, z: Complex<f64>, theta: f64) -> f64 {
    ...
    (match n {
        ...
        6 => {
            ...
            (z5 * 120.0).inv()
                * (tz * tz * tz * tz * tz * ci
                    + tz * (tz * tz - Complex::new(6.0, 0.0)) * c
